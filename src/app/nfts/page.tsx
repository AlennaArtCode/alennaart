...
const HeroSection = ({ onOpenModal }: { onOpenModal: (piece: typeof AURUM_GENESIS[0]) => void }) => (
...
const TimelineSection = ({ isInView }: { isInView: boolean }) => (
...
const UtilitySection = ({ isInView }: { isInView: boolean }) => (
...
const CollectionSection = ({ onOpenModal, isInView }: { onOpenModal: (piece: typeof AURUM_GENESIS[0]) => void, isInView: boolean }) => (
...
const NFTDetailModal = ({ piece, onClose }: { piece: typeof AURUM_GENESIS[0], onClose: () => void }) => (
